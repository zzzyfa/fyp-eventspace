...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit Event | EventSpace</title>
            ...
            <div id="main-contact-form" class="contact-form">
                ...
                <br />
                        ...
                        <div class="form-group" style="height: 300px; margin-bottom: 30px">
                            ...
                            <br />
                            <label style="font-size: small">Optional : Choose a different file below to update the above image. Kindly ensure your banner is optimized for 851 pixels wide and 315 pixels tall.</label>
