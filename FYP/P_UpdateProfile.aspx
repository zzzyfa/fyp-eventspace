<%@ Page Language="C#"  MasterPageFile="User.master"  AutoEventWireup="true" CodeFile="P_UpdateProfile.aspx.cs" Inherits="FYP.P_UpdateProfile" %>
                ...
                <div id="main-contact-form" class="contact-form">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtPhoneNo" runat="server" class="form-control" TextMode="Number" ></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Save Changes" class="btn btn-primary btn-lg" OnClick="btnSave_Click" />
                            <asp:Label ID="lblSuccess" runat="server" Text="Success! Your profile has been updated." Visible="false" ForeColor="Green"></asp:Label>
                        </div>
