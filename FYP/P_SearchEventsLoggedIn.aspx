<%@ Page Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeFile="P_SearchEventsLoggedIn.aspx.cs" Inherits="FYP.P_SearchEventsLoggedIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="HiddenField2" runat="server" Value="all" />
        ...
        <div class="container" style="margin-top:130px; margin-bottom:50px">
            <a href="P_BrowseLoggedIn.aspx"><h5 style="color: orangered" class="a">←Back to Full Event Catalog</h5></a>
            ...
            <div class="inner_sec_info_wthree_agile">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [EVENTS_CREATED] WHERE (event_eligibility=@event_eligibility or event_eligibility=@event_eligibility2) and event_name LIKE @event_name and event_status=@event_status">
